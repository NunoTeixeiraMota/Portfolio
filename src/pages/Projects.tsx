...
const descriptions: { [key: string]: string } = {
    ...
    'Data-Driven-Predictions-on-CO2-Emissions':'About This Project 📘 \n This analysis spans CO2 emissions from 1900 to 2021 in Portugal and selected regions, employing Exploratory Data Analysis (EDA), Statistical Inference, Correlation Analysis, and Linear Regression Modeling to compare trends and predict future emissions.\n\n Technologies Used 💻🔬 \n Python: For data analysis and modeling.\nPandas & NumPy: Data manipulation and statistical analysis.\nMatplotlib & Seaborn: Visualization tools for charts and heatmaps. \nSciPy & Statsmodels: Advanced statistical tests and regression analysis',
    'TelegramGroupBot':`A Python-based Telegram bot that forwards messages from authorized users to a specific group and sends welcome messages to new members. The bot supports text messages, photos, and document-type images. 📱✨`
};
